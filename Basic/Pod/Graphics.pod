...
THIS TRUE ? ***). Backend-independent output: you get the same plots, 
whichever of the graphical module you manage to install.

L<PDL::Graphics::Simple> is a unified backend-independent plotting interface 
...
functionality that are beyond what L<PDL::Graphics::Simple> can do. For
...
L<PDL::Graphics::Prima> lets you focus on what you want to visualize
...
Gnuplot is in general easier to manipulate (*** TODO: IS
...
TODO: is that the correct authors information?
